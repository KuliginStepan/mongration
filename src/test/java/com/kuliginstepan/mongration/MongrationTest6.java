...
import changelogs.SimpleChangeLog6;
...
@Import(SimpleChangeLog6.class)
public class MongrationTest6 {
    ...
    public void test() {
        ...
        assertEquals(SimpleChangeLog6.class.getName(), migrations.get(0).getString("changeLogClass"));
