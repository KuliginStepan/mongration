...
import changelogs.SimpleChangeLog10;
...
@Import(SimpleChangeLog10.class)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
public class MongrationTest10 {
    ...
    public void test() {
        ...
        assertEquals(SimpleChangeLog10.class.getName(), migrations.get(0).getString("changeLogClass"));
