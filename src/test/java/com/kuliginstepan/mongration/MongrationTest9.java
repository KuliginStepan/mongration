...
import changelogs.SimpleChangeLog9;
...
@Import(SimpleChangeLog9.class)
@ActiveProfiles("db")
public class MongrationTest9 {
    ...
    public void test() {
        ...
        assertEquals(SimpleChangeLog9.class.getName(), migrations.get(0).getString("changeLogClass"));
