...
import changelogs.SimpleChangeLog7;
import initdata.MongrationTest7Configuration;
...
@Import({SimpleChangeLog7.class, MongrationTest7Configuration.class})
@ActiveProfiles("db")
public class MongrationTest7 {
    ...
    public void test() {
        ...
        assertEquals(SimpleChangeLog7.class.getName(), migrations.get(0).getString("changeLogClass"));
