...
import changelogs.SimpleChangeLog17;
...
@Import(SimpleChangeLog17.class)
public class MongrationTest17 {
    ...
    public void test() {
        ...
        assertEquals(SimpleChangeLog17.class.getName(), migrations.get(0).getString("changeLogClass"));
        ...
        assertEquals(SimpleChangeLog17.class.getName(), migrations.get(1).getString("changeLogClass"));
